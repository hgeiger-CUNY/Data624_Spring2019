...
Let's just keep this sample and average the nearest non-missing day before and day after for all of these.
...
nearest_before <- c(nearest_before,this_nearest_before[length(this_nearest_before)])
nearest_after <- c(nearest_after,this_nearest_after[1])
}

missing_dates_dat <- data.frame(Day = weekdays(missing_dates),
	Date = missing_dates,
	Before = as.Date(nearest_before,origin="1970-01-01"),
	After = as.Date(nearest_after,origin="1970-01-01"))
```
