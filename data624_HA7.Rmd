...
### Part 2 - STL decomposition to seasonally adjust data
...
### Part 3 - Forecast using additive damped trend.
...
### Part 4 - Forecast using additive trend, NOT damped.
...
### Part 5 - Choose seasonal model for the data using the ets function.
...
### Part 6 - Compare RSME from these models.
...
### Part 7 - Compare forecasts from these models.
...
Based on this, plus the fact that the RSME was not *that* much worse for the ETS model, I will proceed with the ETS model from here on out.

### Part 8 - Check residuals of preferred model.
